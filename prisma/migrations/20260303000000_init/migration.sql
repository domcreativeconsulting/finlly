-- =============================================================================
-- Finlly v2 — Initial Migration (PostgreSQL)
-- Migration: 20260303000000_init
-- =============================================================================
...
-- Valor atual = SUM(investimentos_eventos) filtrado por tipo.
...
-- valor_atual = SUM(metas_movimentos) — não armazenado.
CREATE TABLE metas (
  id          UUID          PRIMARY KEY DEFAULT gen_random_uuid(),
  usuario_id  UUID          NOT NULL,
  nome        VARCHAR(255)  NOT NULL,
