...
const NAV_ITEMS = [
  {
    icon: <FontAwesomeIcon icon={faChartPie} style={{ fontSize: '18px' }} />,
    label: 'Dashboard',
    path: '/dashboard',
  },
  {
    icon: <FontAwesomeIcon icon={faArrowUp} style={{ fontSize: '18px' }} />,
    label: 'Contas a pagar',
    path: '/contas-pagar',
  },
  {
    icon: <FontAwesomeIcon icon={faArrowDown} style={{ fontSize: '18px' }} />,
    label: 'Contas a receber',
    path: '/contas-receber',
  },
  {
    icon: <FontAwesomeIcon icon={faChartLine} style={{ fontSize: '18px' }} />,
    label: 'Investimentos',
    path: '/investimentos',
  },
  { icon: <FontAwesomeIcon icon={faBullseye} style={{ fontSize: '18px' }} />, label: 'Metas', path: '/metas' },
  { icon: <FontAwesomeIcon icon={faPaperclip} style={{ fontSize: '18px' }} />, label: 'Anexos', path: '/anexos' },
  {
    icon: <FontAwesomeIcon icon={faRightFromBracket} style={{ fontSize: '18px' }} />,
    label: 'Sair',
    path: '/logout',
    isLogout: true,
  },
