...
export default function InvestimentosPage() {
  ...
  const saldoColor = (val) =>
    val > 0 ? '#16a34a' : val < 0 ? '#dc2626' : '#6b7280';
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div>
              <label style={labelStyle}>
                Produto / Descrição <span style={{ color: '#ef4444' }}>*</span>
              </label>
              <input
                style={inputStyle}
                type="text"
          ...
          >
            ...
            <div>
              <label style={labelStyle}>
                Taxa anual (% a.a.) <span style={{ color: '#ef4444' }}>*</span>
              </label>
              <input
                style={inputStyle}
                type="number"
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, modeloRentabilidade: e.target.value }))
              }
              onFocus={handleInputFocus}
              onBlur={handleInputBlur}
            >
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {modalCriarEvento && (
            <div
              style={{ background: '#f3f4f6', borderRadius: 8, padding: 16 }}
            >
              <form
