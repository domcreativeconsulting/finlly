  ...
  return (
    <div style={s.pageWrapper}>
      ...
      <Modal
        open={modalAberto}
        onClose={fecharModal}
        title={contaEmEdicao ? 'Editar conta a receber' : 'Nova conta a receber'}
        maxWidth="520px"
      ...
      >
            ...
            <form onSubmit={handleConfirmarRecebimento}>
              ...
              <div style={s.modalActions}>
                <Button type="button" variant="ghost" onClick={fecharModalReceber} disabled={recebendo}>
                  Cancelar
                </Button>
                <Button type="submit" loading={recebendo} style={{ background: colors.success }}>
      ...
      >
                    ...
                    <React.Fragment key={cat.id}>
                      <tr style={{ borderBottom: '1px solid #f1f5f9' }}>
                        ...
                        <td style={{ padding: '10px 12px' }}>
                          <span style={{ display: 'inline-block', padding: '2px 8px', borderRadius: '999px', fontSize: '11px', fontWeight: 600, background: '#dcfce7', color: '#166534' }}>Principal</span>
                        </td>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '20px' }}>
              <Button variant="secondary" onClick={fecharModalCategorias}>Fechar</Button>
            </div>
      </Modal>
    </div>
  );
