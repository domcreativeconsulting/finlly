...
const envSchema = z.object({
  ...
  EVOLUTION_TIMEOUT_MS: z.coerce.number().int().positive().default(8000),  // 8s per attempt
  EVOLUTION_MAX_RETRIES: z.coerce.number().int().min(0).max(5).default(2), // 2 retries (3 attempts total)
