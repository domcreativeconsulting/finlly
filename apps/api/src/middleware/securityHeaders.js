 ...
 *
 * Note: Strict-Transport-Security is only applied in production (NODE_ENV === 'production')
 * to avoid issues in local development environments where HTTPS is not guaranteed.
 *
