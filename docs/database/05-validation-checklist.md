...
| 6   | Billing & Assinaturas   | `cupons`               |     ✅ `id`     | ✅ (nenhuma) |        ✅        | `01-legacy-schema-mapping.md` §2 |
...
| ---------------------------- | :-: | -------------------------------------------------- |
| ✅ Explícita no DDL          |  0  | _(nenhuma no legado)_                              |
...
| `code`                   | `cupons`                                                                                                                     |      ❌       | **Ausente** — full table scan na validação |
...
| CR-06  | `cupons.code` Sem UNIQUE                                             | 🔴 Crítico | `03-legacy-issues.md` |
...
| ME-08  | `cupons.discount_type` Como String Livre                             |  🟡 Médio  | `03-legacy-issues.md` |
...
_Documentos relacionados: `00-index.md`, `01-legacy-schema-mapping.md`, `02-relationships-matrix.md`,
`03-legacy-issues.md`, `04-indexing-strategy.md`_
